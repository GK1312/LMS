    ...
    <>
      ...
      >
        ...
        {Object.keys(errors).length > 0 && (
          <div
            className={`input_error_box ${!isValid ? "h-6" : "h-0"} relative`}
          >
            {!isValid && (
        ...
        <button
          type="submit"
          className="w-full min-h-9 px-5 py-2 text-xs text-white leading-none tracking-wider font-semibold uppercase inline-flex items-center justify-center bottom-0 outline-0 bg-accent-theme select-none rounded-md transition-all duration-100 ease-in-out hover:bg-accent-theme-dark"
        >
          Verify OTP
        </button>
      </form>
